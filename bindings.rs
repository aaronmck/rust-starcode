...
pub const VERSION: &[u8; 14usize] = b"starcode-v1.4\0";
pub const DATE: &[u8; 11usize] = b"2021-09-22\0";
pub const STARCODE_MAX_TAU: u32 = 8;
...
pub const DESTROY_NODES_YES: u32 = 1;
pub const DESTROY_NODES_NO: u32 = 0;
pub const TAU: u32 = 8;
pub const M: u32 = 1024;
pub const MAXBRCDLEN: u32 = 1023;
pub const GSTACK_INIT_SIZE: u32 = 16;
...
pub const output_t_TIDY_OUTPUT: output_t = 3;
pub type output_t = ::std::os::raw::c_uint;
pub const cluster_t_MP_CLUSTER: cluster_t = 0;
pub const cluster_t_SPHERES_CLUSTER: cluster_t = 1;
pub const cluster_t_COMPONENTS_CLUSTER: cluster_t = 2;
pub type cluster_t = ::std::os::raw::c_uint;
extern "C" {
    pub fn starcode_helper(
        input: *mut ::std::os::raw::c_char,
        output: *mut ::std::os::raw::c_char,
        tau: ::std::os::raw::c_int,
        verbose: ::std::os::raw::c_int,
        thrmax: ::std::os::raw::c_int,
        clusteralg: ::std::os::raw::c_int,
        parent_to_child: f64,
        showclusters: ::std::os::raw::c_int,
...
extern "C" {
    pub static BASES: [::std::os::raw::c_char; 8usize];
}
extern "C" {
...
extern "C" {
    pub fn count_nodes(arg1: *mut trie_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn destroy_tower(arg1: *mut *mut gstack_t);
}
extern "C" {
    pub fn destroy_trie(
        arg1: *mut trie_t,
...
extern "C" {
    pub fn insert_string_wo_malloc(
        arg1: *mut trie_t,
...
extern "C" {
    pub fn new_gstack() -> *mut gstack_t;
}
extern "C" {
    pub fn new_tower(arg1: ::std::os::raw::c_int) -> *mut *mut gstack_t;
}
extern "C" {
    pub fn new_trie(arg1: ::std::os::raw::c_uint) -> *mut trie_t;
}
extern "C" {
    pub fn push(
        arg1: *mut ::std::os::raw::c_void,
        arg2: *mut *mut gstack_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn search(
...
#[test]
fn bindgen_test_layout_trie_t() {
    const UNINIT: ::std::mem::MaybeUninit<trie_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<trie_t>(),
        16usize,
        concat!("Size of: ", stringify!(trie_t))
    );
    assert_eq!(
        ::std::mem::align_of::<trie_t>(),
        8usize,
        concat!("Alignment of ", stringify!(trie_t))
    );
    assert_eq!(
...
#[derive(Debug, Copy, Clone)]
pub struct node_t {
    pub child: [*mut ::std::os::raw::c_void; 6usize],
    pub path: u32,
    pub cache: [::std::os::raw::c_char; 17usize],
}
#[test]
fn bindgen_test_layout_node_t() {
    const UNINIT: ::std::mem::MaybeUninit<node_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
pub struct gstack_t {
    pub nslots: usize,
    pub nitems: usize,
    pub items: __IncompleteArrayField<*mut ::std::os::raw::c_void>,
}
#[test]
fn bindgen_test_layout_gstack_t() {
    const UNINIT: ::std::mem::MaybeUninit<gstack_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<gstack_t>(),
        16usize,
        concat!("Size of: ", stringify!(gstack_t))
    );
    assert_eq!(
        ::std::mem::align_of::<gstack_t>(),
        8usize,
        concat!("Alignment of ", stringify!(gstack_t))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nslots) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(gstack_t),
...
#[test]
fn bindgen_test_layout_info_t() {
    const UNINIT: ::std::mem::MaybeUninit<info_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<info_t>(),
        16usize,
        concat!("Size of: ", stringify!(info_t))
    );
    assert_eq!(
        ::std::mem::align_of::<info_t>(),
        8usize,
        concat!("Alignment of ", stringify!(info_t))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).pebbles) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(info_t),
